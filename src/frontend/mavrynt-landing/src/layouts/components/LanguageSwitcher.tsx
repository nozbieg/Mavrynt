...
/**
 * LanguageSwitcher — native `<select>` keeps a11y, keyboard support, and
 * i18n overhead trivial. Upgrade to a custom listbox later if/when
 * product design justifies the complexity.
 */
