/**
 * Admin i18n bootstrap.
 *
 * Uses the shared factory from `@mavrynt/config/i18n` so all three SPAs
 * share the same setup contract (DRY). Locale resource JSON lives next
 * to this file; add keys in `locales/{en,pl}/common.json`.
 *
 ...
 * it before rendering — guarantees translations are ready on first
