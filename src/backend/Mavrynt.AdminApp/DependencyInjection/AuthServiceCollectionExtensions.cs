...
namespace Mavrynt.AdminApp.DependencyInjection;
...
public static class AuthServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    // "sub" claim maps to Identity.Name; role checks rely on ClaimTypes.Role,
                    // which is how access tokens are emitted by JwtTokenService.
                    NameClaimType = "sub",
        ...
        {
            // Protects admin-only endpoints — caller must have role "Admin".
